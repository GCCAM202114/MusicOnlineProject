...
--
INSERT INTO `album` (`id`, `albName`, `albDescription`, `release_date`,
`fk_genre_id`, `fk_artist_id`, `fk_record_label_id`, `is_active`, `image`,
`fk_user_id`) VALUES
(121, 'Ruins', 'Description', NULL, 2, 135, 5, 1, 'firstaid.jpg', 27),
(130, 'Changing Horses', 'Description', NULL, 2, 144, 3, 1,
'benkweller_changinhorses.jpg', 27),
(131, 'O brother where art thou', 'Description', NULL, 11, 145, 4, 1, 'br.jpg',
27),
(132, 'Sgt Pepper', 'Description', NULL, 1, 146, 5, 1, 'bratles_sgtpr.jpg', 27),
(133, 'Tapestry', 'Description', NULL, 11, 147, 7, 1, 'caroleking_tapestry.jpg',
27),
(134, 'Colour by numbers', 'Description', NULL, 1, 148, 6, 1, 'cc.jpg', 27),
(136, 'The Collection', 'Description', NULL, 1, 150, 7, 1,
'dodgy_thecollection.jpg', 27),
(137, 'Move your feet', 'Description', NULL, 1, 151, 8, 1,
'juniorsenior_move_your_feet.jpg', 27),
(138, 'Misunderstood', 'Description', NULL, 3, 152, 9, 1, 'pink_misunderstood.jpg',
27),
(139, 'The Riddle', 'Description', NULL, 1, 153, 7, 1, 'nikkershaw_riddle.jpg',
27),
(140, 'Get behind me satan', 'Description', NULL, 3, 154, 5, 1,
'thewhitestripes_satan.jpg', 27),
(141, 'Up at the Lake', 'Description', NULL, 2, 155, 5, 1,
'thecharlatans_upatthelake.jpg', 27),
(142, 'Yellow Submarine', 'Description', NULL, 1, 156, 7, 1,
'thebeatles_yellow_submarine.jpg', 27),
(143, 'Greatest Hits', 'Description', NULL, 1, 157, 7, 1,
'elvis_greatest_hits.jpg', 27);
-- --------------------------------------------------------
--
...
--
INSERT INTO `user` (`id`, `password`, `is_admin`, `email`, `is_active`, `username`,
`pw`) VALUES
(26, '$2y$10$UcV3.Pvs9b7Jw5IHcaHgbuNw1d765BsUyED29ueHy9eamVMmLHr3u', 1,
'admin@email.com', 1, 'admin', NULL),
(27, '$2y$10$BQ.jxuz7e12MGFNDSNMKH.sivaZV2/PH5oDWbosc58EpVIWCWvXIC', 0,
'user@email.com', 1, 'user', NULL);
--
...
--
ALTER TABLE `album`
ADD CONSTRAINT `album_ibfk_1` FOREIGN KEY (`fk_genre_id`) REFERENCES `genre`
(`id`),
ADD CONSTRAINT `album_ibfk_2` FOREIGN KEY (`fk_record_label_id`) REFERENCES
`record_label` (`id`),
ADD CONSTRAINT `album_ibfk_3` FOREIGN KEY (`fk_artist_id`) REFERENCES `artist`
(`id`),
ADD CONSTRAINT `album_ibfk_4` FOREIGN KEY (`fk_user_id`) REFERENCES `user`
(`id`);
COMMIT;
